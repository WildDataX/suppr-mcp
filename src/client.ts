...
export class SupprClient {
  ...
  async createTranslation(params: {
    ...
    const result =
      (await response.json()) as SupprAPIResponse<CreateTranslationResponse>;
  ...
  async listTranslations(params?: {
    ...
    const url = `${this.baseURL}/v1/translations${
    ...
    const result =
      (await response.json()) as SupprAPIResponse<TranslationListResponse>;
  ...
  async searchDocuments(params: DocSearchRequest): Promise<DocSearchResponse> {
    ...
    const result =
      (await response.json()) as SupprAPIResponse<DocSearchResponse>;
